...
hl.bind(mainMod .. " + CONTROL + Right", hl.dsp.window.move({ workspace = "m+1" }))
hl.bind(mainMod .. " + CONTROL + Left", hl.dsp.window.move({ workspace = "m-1" }))
...
hl.bind(mainMod .. " + SHIFT + Down", hl.dsp.focus({ workspace = "emptym" }))
